...
int main(int argc, char** argv) {
    if (argc != 4) {
        std::cout << "Usage: ./afn17_client <log_database_size> <access_times> <element_size>" << std::endl;
        return -1;
    }
    ...
    setupT += time2 - time1;
    access_times = client.Z_value >> 1;
    size_t progress_interval = access_times / 10;
    std::cout << "access_times:: " << access_times << "\n";
    for (size_t i = 0; i < access_times; i++) {
        ...
        // print_element(ele, element_size);
