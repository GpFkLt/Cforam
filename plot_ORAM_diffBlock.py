...
for i in range(len(schemeL)):
    csv_file = f'{schemeL[i]}/Result/DiffBlock_{para[0]}.csv'
    ...
    csv_file_wan = f'{schemeL[i]}/Result/DiffBlock_{para[1]}.csv'
...
plt.savefig('oram_diff_block.pdf', bbox_inches='tight', dpi=600)
plt.close()
plt.show()
